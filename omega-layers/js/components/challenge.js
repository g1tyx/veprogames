Vue.component("challenge", {
    ...
    <p v-else>已完成！</p>
    <p v-if="challenge.level > 0">奖励: {{challenge.getRewardDescription()}}</p>
    <p>目标: {{formatNumber(challenge.getResourceGoal(), 2, 2)}} <resource-name :layerid="challenge.goalLayer.layer"></resource-name></p>
</button>`
});