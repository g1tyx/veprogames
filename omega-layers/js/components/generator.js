Vue.component("generator",{
    ...
    template: `<tr>
<td>发生器 <layer-colored-text :layerid="generator.layer.layer" v-html="generator.name"></layer-colored-text> <span style="font-size: 70%;">x {{formatNumber(generator.getProductionMulti(), 2, 0)}}</span></td>
