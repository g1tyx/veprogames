...
var cnItems = {
    ...
    'It never Ends': '永不停息',
    'Inf-Infinity': '超越无限',
    'Achievement Get: Starting Out': '获得成就: 启程出发',
    'Achievement Get: The beginning of Idling': '获得成就: 放置之始',
    'Achievement Get: Polynomial Growth': '获得成就: 多项式增长',
    'Achievement Get: Still Polynomial Growth': '获得成就: 还是多项式增长',
    'Achievement Get: A Square of Generators': '获得成就: 发生器方形',
    'Achievement Get: Pentagen': '获得成就: 发生器五方',
    'Achievement Get: Power of Six': '获得成就: 我是六号',
    'Achievement Get: Seven Heaven': '获得成就: 第七天堂',
    'Achievement Get: Octacore': '获得成就: 八核',
    'Achievement Get: Upgradalicious': '获得成就: 优质升级',
    'Achievement Get: Stonks': '获得成就: 储备丰富',
    'Achievement Get: Other Times Await': '获得成就: 来生再会',
    'Achievement Get: POW': '获得成就: 能量',
    'Achievement Get: Polynomial POW': '获得成就: 多项式能量',
    'Achievement Get: In thousands': '获得成就: 数以千计',
    'Achievement Get: Other Times Arrived': '获得成就: 来生已至',
    'Achievement Get: Automatic!': '获得成就: 自动运转',
    'Achievement Get: Exploding Numbers': '获得成就: 数值爆炸',
    'Achievement Get: A big Boost': '获得成就: 巨大加成',
    'Achievement Get: A Square of Power': '获得成就: 能量方形',
    'Achievement Get: Another Layer?!': '获得成就: 又来一层？！',
    'Achievement Get: Other Times Await... Again': '获得成就: 来生……再再会',
    'Achievement Get: POγγ': '获得成就: γ的能量',
    'Achievement Get: The True Time': '获得成就: 真实时间',
    'Achievement Get: More Gamma, more Boost': '获得成就: 伽马既涨，加成当附',
    'Achievement Get: Huge Numbers': '获得成就: 巨额数字',
    'Achievement Get: How Challenging': '获得成就: 挑战，就这？',
    'Achievement Get: Persistence': '获得成就: 持续性',
    'Achievement Get: Other Times Await... Yet Again': '获得成就: 来生……还再会',
    'Achievement Get: Aleph-': '获得成就: 阿列夫-',
    'Achievement Get: It all runs by itself': '获得成就: 无人值守',
    'Achievement Get: How many are there?!': '获得成就: 还有多少层啊？！',
    'Achievement Get: It\'s time to stop! (not': '获得成就: 该停下来了吧！(并不',
    'Achievement Get: End Game?': '获得成就: 到游戏末期了吗？',
    'Achievement Get: Temperature': '获得成就: 温度',
    'Achievement Get: Stack A-New!': '获得成就: 叠出一片新天地！',
    'Achievement Get: H λ l f L i f e': '获得成就: 半 λ 条 λ 命',
    'Achievement Get: One for Everyone': '获得成就: 见者有份',
    'Achievement Get: What\'s the Point of Layers?': '获得成就: 层级的存在意义是什么？',
    'Achievement Get: Wake Up': '获得成就: 醒悟',
    'Achievement Get: Ω-Layers': '获得成就: Ω-层级',
    'Achievement Get: One for each Second': '获得成就: 一秒一个',
    'Achievement Get: The Ladder is Infinite': '获得成就: 无尽的阶梯',
    'Achievement Get: Stupidly fast': '获得成就: 快到发呆',
    'Achievement Get: What are Layer resets?': '获得成就: 层级重置是什么？',
    'Achievement Get: Faster than Light': '获得成就: 超越光速',
    'Achievement Get: It never Ends': '获得成就: 永不停息',
    'Achievement Get: Inf-Infinity': '获得成就: 超越无限',
    'Reach 10 α': '到达10α',
    ...
    'Go ε': '到达ε',
    'Go ζ': '到达ζ',
    'Reach 1e1,000,000,000 α': '到达1e1000000000α',
    'Go θ': '到达θ',
    'Go λ': '到达λ',
...
var cnRegReplace = new Map([
    ...
    [/^(\s*)To start, click the  "+1 α" button until you have 10 α. With 10 α, you can buy a Generator α$/, '首先，先点击 +1α 按钮，直到您一共获得了10α。这样您就可以购买发生器α'], //教程
    ...
    [/^(\s*)This applies to basically everything like certain challenge rewards, Upgrade Effects and Power Boosts.$/, '它几乎对所有相关参数都有效，例如特定的挑战奖励，升级效果及能量加成等。'], //教程
